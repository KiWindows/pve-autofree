...
# This project is licenced under the WTFPL licence.
#
...
" optupdate
        ...
        cp /usr/share/javascript/proxmox-widget-toolkit/proxmoxlib.js /usr/share/javascript/proxmox-widget-toolkit/proxmoxlib.js.org
